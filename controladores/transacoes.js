...
const cadastrarTransacao = async (req, res) => {
    ...
    if (await validarCampos(req)) {
        ...
        try {
            ...
            const querySelect = 'select * from transacoes where usuario_id = $1 order by id desc limit 1';
...
const validarCampos = async (req) => {
    ...
    try {
        ...
        const existeId = categorias.find((categoria) => {
